...
class StoreProfileView(generics.RetrieveUpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        if not pin or not profile.validate_pin(pin):
            return create_error_response("Invalid PIN.", {"pin": ["Invalid PIN"]}, status.HTTP_400_BAD_REQUEST)
...
class GenerateNewPinView(APIView):
    ...
    def put(self, request, *args, **kwargs):
        ...
        return create_success_response("New PIN generated and sent to your email.", {}, status.HTTP_200_OK)
...
class StoreItemCategoriesView(generics.ListCreateAPIView):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return create_success_response("Categories retrieved successfully.", serializer.data, status.HTTP_200_OK)
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return create_success_response("Categories updated successfully.", {}, status.HTTP_200_OK)
        return create_error_response("Categories update failed.", serializer.errors, status.HTTP_400_BAD_REQUEST)
...
class StoreItemConditionsView(generics.ListCreateAPIView):
    ...
    def list(self, request, *args, **kwargs):
        queryset = self.get_queryset()
        serializer = self.get_serializer(queryset, many=True)
        return create_success_response("Conditions retrieved successfully.", serializer.data, status.HTTP_200_OK)
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            return create_success_response("Conditions updated successfully.", {}, status.HTTP_200_OK)
        return create_error_response("Conditions update failed.", serializer.errors, status.HTTP_400_BAD_REQUEST)
...
class StoreProfileImageView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        serializer = StoreProfileImageUploadSerializer(data=request.data, context={"request": request})
        if serializer.is_valid():
    ...
    def delete(self, request, *args, **kwargs):
        serializer = StoreProfileImageDeleteSerializer(data=request.data, context={"request": request})
        if serializer.is_valid():
            profile = serializer.save()

...
urlpatterns = [
    ...
    path(
        ...
        create_onboarding_session_view,
        name="stripe-onboarding-session",
    ),
    path(
        "stripe/management-session/",
        create_management_session_view,
        name="stripe-management-session",
    ),
    path(
        "stripe/payouts-session/",
        create_payouts_session_view,
        name="stripe-payouts-session",
    ),
    path(
        "stripe/payments-session/",
        create_payments_session_view,
        name="stripe-payments-session",
    ),
    path(
        "stripe/notifications-session/",
        fetch_notifications_view,
        name="stripe-notifications-session",
    ),
    path(
        "stripe/item-checkout-session/",
        create_stripe_item_checkout_secssion_view,
        name="stripe-item-checkout-session",
    ),
    path(
        "stripe/supplies-checkout-session/",
        create_stripe_supplies_checkout_session_view,
        name="stripe-supplies-checkout-session",
    ),
    path(

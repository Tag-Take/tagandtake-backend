...
class PaymentTransaction(models.Model):
    ...
    item = models.ForeignKey('items.Item', on_delete=models.CASCADE, related_name='item_transactions')
    member = models.ForeignKey(Member, on_delete=models.CASCADE, related_name='member_transactions')
    store = models.ForeignKey(Store, on_delete=models.CASCADE, related_name='store_transactions')

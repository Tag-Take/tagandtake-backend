...
class MemberNotificationPreferencesView(generics.RetrieveUpdateAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        return create_success_response("Notification preferences retrieved successfully.", serializer.data, status.HTTP_200_OK)
    ...
    def update(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return create_success_response("Notification preferences updated successfully.", serializer.data, status.HTTP_200_OK)
        return create_error_response("Notification preferences update failed.", serializer.errors, status.HTTP_400_BAD_REQUEST)
